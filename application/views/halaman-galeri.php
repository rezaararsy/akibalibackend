...
<html lang="en">
  ...
  <head>
    <title>AKI 24 Jam Bali | Galeri</title>
    <meta charset="utf-8">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
            ...
            <div class="row align-items-center position-relative ">
              ...
              <div class="col-6 text-right topnav" id="myTopNav">
                <ul class="menu text-right">
                  ...
                  <li class="menu-item"><a class="btn-navi btn-navi-primary btn-navi-outline-black current py-3 px-3" href="<?php echo base_url(). 'index.php/halaman_galeri'; ?>">Galeri</a></li>
              ...
              <div class="col-1 text-left topbar black">
                ...
                <nav class="site-navigation text-right ml-auto d-none d-lg-none" role="navigation">
                  ...
                  <li class="active"><a href="<?php echo base_url(). 'index.php/halaman_galeri'; ?>" class="nav-link">Galeri</a></li>
    ...
    <div class="site-section animated fadeIn">
      <div class="container martop">

        <div class="row mb-5">
          <div class="col-md-7 mx-auto text-center ">
            <h2 class="heading-29190">Galeri</h2>
          </div>
        </div>
